...
function MessageBar() {
    ...
    const handleSubmit = () => {
        ...
        if (!text) return;
        // TODO: wire up actual send action here
        // console.log("Send:", text);
        setValue("");
        // After clearing, also reset height
    ...
    return (
        ...
        >
            ...
            />
            <button
                className={`flex items-center justify-center text-xl hover:cursor-pointer shrink-0 rounded-full p-1.5 bg-brandColor ${isMultiline ? "self-end" : ""}`}
                type="submit"
